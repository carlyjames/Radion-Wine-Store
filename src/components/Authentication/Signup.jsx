...
import FormImage from "../Images/hd2.jpg";
          ...
          <div className="  form-holder shadow-lg">
            ...
            <div className="form-item form">
              <Form
                ...
                className="row g-3 m-0 shadow-lg  "
              ...
              >
                ...
                <FormLabel className="mx-2">
                  <small>
                    Birthday <HelpIcon style={{ fontSize: "14px" }} />{" "}
                  </small>{" "}
                </FormLabel>
                ...
                <FormLabel className="mx-2">
                  <small>
                    Gender <HelpIcon style={{ fontSize: "14px" }} />{" "}
                  </small>{" "}
                </FormLabel>
                <RadioGroup
                  row
                ...
                <div
                  className="w-100 text-left mt-2 text-black-50"
                  style={{ fontSize: "14px" }}
                >
